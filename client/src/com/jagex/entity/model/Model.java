...
public class Model extends Renderable {
	...
	public void apply(int frame) {
		...
		for (int transformation = 0; transformation < animation.getTransformationCount(); transformation++) {
			...
			transform(base.getTransformationType(group), base.getLabels(group),
					animation.getTransformX(transformation), animation.getTransformY(transformation),
					animation.getTransformZ(transformation));
		}
	}
	...
	public final void method480(int lighting, int j, int x, int y, int z) {
		for (int face = 0; face < faces; face++) {
			...
			if (anIntArray489 == null) {
				...
				int light = lighting + (x * normal.getX() + y * normal.getY() + z * normal.getZ())
						/ (j * normal.getFaceCount());
				anIntArray1634[face] = checkedLight(colour, light, 0);

				normal = super.normals[indexY];
				light = lighting + (x * normal.getX() + y * normal.getY() + z * normal.getZ())
						/ (j * normal.getFaceCount());
	...
	public final void render(int x, int y, int orientation, int j, int k, int l, int i1, int height, int key) {
		...
		int j3 = y * l + x * i1 >> 16;
		int k3 = j3 - boundingPlaneRadius << 9;
		if (k3 / i3 >= Raster.getCentreX()) {
			return;
		}

		int l3 = j3 + boundingPlaneRadius << 9;
		...
		for (int face = 0; face < faces; face++) {
			if (anIntArray489 == null || anIntArray489[face] != -1) {
				...
				if (flag && (i3 == -5000 || l3 == -5000 || k4 == -5000)) {
					...
					int j5 = (anIntArray1667[indexX] + anIntArray1667[indexY] + anIntArray1667[indexZ]) / 3 + boundingCylinderRadius;
					...
					if ((i3 - l3) * (anIntArray1666[indexZ] - anIntArray1666[indexY])
						...
						if (i3 < 0 || l3 < 0 || k4 < 0 || i3 > Raster.maxRight || l3 > Raster.maxRight
								|| k4 > Raster.maxRight) {
							aBooleanArray1663[face] = true;
						} else {
							aBooleanArray1663[face] = false;
						}
						int k5 = (anIntArray1667[indexX] + anIntArray1667[indexY] + anIntArray1667[indexZ]) / 3
	...
	private final void method484(int i) {
		...
		if (type == 0) {
			...
			Rasterizer.method376(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j],
					anIntArray1665[k], anIntArray1665[l], anIntArray1691[anIntArray1634[i]]);
		} else if (type == 2) {
			...
			Rasterizer.method378(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j],
					...
					anIntArray1669[l2], anIntArray1670[l1], anIntArray1670[j2], anIntArray1670[l2], faceColours[i]);
		} else if (type == 3) {
			...
			Rasterizer.method378(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j],
					...
					anIntArray1669[i3], anIntArray1670[i2], anIntArray1670[k2], anIntArray1670[i3], faceColours[i]);
		}
	}
			...
			if (l == 3) {
				...
				if (l7 == 0) {
					...
					Rasterizer.method378(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1],
							...
							anIntArray1670[k10], anIntArray1670[k11], faceColours[i]);
				} else if (l7 == 3) {
					...
					Rasterizer.method378(i7, j7, k7, j3, j4, j5, anIntArray1634[i], anIntArray1634[i],
							...
							anIntArray1670[l10], anIntArray1670[l11], faceColours[i]);
				}
			}
			if (l == 4) {
				if (j3 < 0 || j4 < 0 || j5 < 0 || j3 > Raster.maxRight || j4 > Raster.maxRight || j5 > Raster.maxRight
						|| anIntArray1678[3] < 0 || anIntArray1678[3] > Raster.maxRight) {
					Rasterizer.aBoolean1462 = true;
				}
				int i8;
				if (anIntArray489 == null) {
				...
				if (i8 == 2) {
					...
					Rasterizer.method378(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], anIntArray1680[0],
							...
							anIntArray1670[i10], anIntArray1670[i11], anIntArray1670[i12], faceColours[i]);
					return;
				}
				if (i8 == 3) {
					...
					Rasterizer.method378(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], anIntArray1634[i],
							...
							anIntArray1670[j10], anIntArray1670[j11], anIntArray1670[j12], faceColours[i]);
				}
			}
		}
	}
