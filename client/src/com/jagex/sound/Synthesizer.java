...
public class Synthesizer {
	...
	/**
	 * The envelope to modify the release time (i.e. time taken for the level to decay from the sustain level to
	...
	if (volumeMultiplier != null) {
		...
		volumeMultiplierStep = (int) ((volumeMultiplier.end - volumeMultiplier.start) * 32.768D
			/ samplesPerStep);
