...
export default class ReadByte {
     ...
     */
    public static BE(b: Buffer, index: number) {
        return b[index] & 0xff;
    }
    /**
     ...
     */
    public static BES(b: Buffer, index: number) {
        return 128 - b[index] & 0xff;
    }
    /**
     * Reads an unsigned Big-endian at specified index
     */
    public static UBE(b: Buffer, index: number) {
        return b[index] & 0xff;
    }
    /**
     ...
     * May not work as expected
     */
    public static UBEA(b: Buffer, index: number) {
     ...
     * May not work as expected
     */
    public static UBES(b: Buffer, index: number) {
        return 128 - b[index] & 0xff;
    }
}
